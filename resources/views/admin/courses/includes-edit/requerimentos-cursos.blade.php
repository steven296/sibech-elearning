<div id="box-requirements" class="box_general padding_bottom">
    <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Requerimientos</h2>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <td>
                             @foreach ($requirements as $requirement)
                                <div class="row">
                                    <div class="col-md-11">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{$requirement->requirement}}" placeholder="Nombre de la clase" name="requirement[]">
                                    </div>
                                    </div>
                                    <div class="col-md-1">
